...
@section('content')
    <div class="flex items-center justify-between mb-8">
        <h1 class="text-3xl font-bold text-[#0f3150]">Edit User ✏️</h1>
    ...
    <div class="max-w-2xl p-8 bg-white shadow-lg rounded-2xl">
        ...
        <form action="{{ route('users.update', $user->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                <label class="block mb-2 font-semibold text-gray-700">Password (opsional)</label>
            ...
            <div class="flex items-center">
                <button type="submit"
                    class="px-6 py-2 font-semibold text-white transition duration-200 bg-green-600 rounded-lg hover:bg-green-700">
